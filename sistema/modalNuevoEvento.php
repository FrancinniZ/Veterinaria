<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  ...
  <form name="formEvento" id="formEvento" action="nuevoEvento.php" class="form-horizontal" method="POST">
		<div class="form-group">
			<label for="evento" class="col-sm-12 control-label">Paciente</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" name="evento" id="evento" placeholder="Ingrese especialidad y paciente" required/>
			</div>
		</div>
    <div class="form-group">
